            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="<?php echo base_url(). 'index.php/Data_barang/create'; ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan Harga" name="hrg">
                                            </div>
                                            <div class="form-group">
                                                <label for="pillInput">Deskripsi</label>
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan Deskripsi" name="des">
                                            </div>
                                            <div class="form-group">
                                                <label for="pillInput">Berat</label>
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan Berat" name="brt">
                                            </div>
                                            <div class="form-group">
                                                <label for="pillInput">Stok</label>
                                                <input type="text" class="form-control input-pill" id="pillInput" placeholder="Masukkan Stok" name="stokk">
                                            </div>
                                            <div class="form-group">
